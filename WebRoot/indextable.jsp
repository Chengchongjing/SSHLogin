						...
						<div class="bs_nav">
							...
							<div class="bs_navright">
								<span class="icon_no hand"
									onclick='top.Dialog.confirm("确定要退出填报吗",function(){window.location="login.jsp"});'>退出填报</span>
								<div class="clear"></div>
							</div>
							<div class="clear"></div>
						</div>
								...
								<div id="lbox_middleright">
									<div id="bs_left">
										<IFRAME scrolling="no" width="100%" frameBorder=0 id=frmleft
											name=frmleft src="leftPages/mode.html"
								...
								<div id="rbox_middleright">
									<div id="bs_right">
										<IFRAME scrolling="yes" width="100%" height="100%"
											frameBorder=0 id=frmright name=frmright src="table.jsp"
											allowTransparency="true"> </IFRAME>
									</div>
								</div>
							</div>
